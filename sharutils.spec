...
# compress-dummy.1 is empty (#584673)
# upstream 4.8 version does not deliver this file any more.
...
%changelog
* Thu Apr 22 2010 Petr Pisar <ppisar@redhat.com> - 4.7-6.1
- Remove empty compress-dummy(1) manual page (#584673)
- Fix this changelog entry e-mail address

* Mon Nov 30 2009 Dennis Gregorovic <dgregor@redhat.com> - 4.7-5.1
- Rebuilt for RHEL 6
